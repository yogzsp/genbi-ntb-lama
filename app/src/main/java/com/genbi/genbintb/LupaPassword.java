...
public class LupaPassword extends AppCompatActivity {
    ...
    public void VerifikasiPassword(View view) {
        ...
        String EmailShared = sharedPreferences.getString(ManajemenSesi.SEM_EMAIL,null);
        ...
        if(spasswordbaru.equals(srepassword)) {
            ...
            if (Kesalahan == 0) {
                MembuatDataServer(EmailShared, spasswordbaru);
            }
        }else {
    ...
    public void MembuatDataServer(final String email, final String passwordbaru){
        if(checkKoneksi()){
//            progressDialog.show();
//            progressDialog.setMessage("Memeriksa akun");
            final RequestQueue requestQueue= Volley.newRequestQueue(LupaPassword.this);
            StringRequest stringRequest=new StringRequest(Request.Method.POST, DBContact.SERVER_LUPAPASSWORD,
